...
import com.ester.appleshop.activities.DetailedActivity;
...
public class ViewAllAdapter extends RecyclerView.Adapter<ViewAllAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewAllAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.price.setText(list.get(position).getPrice()+"/piece");

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, DetailedActivity.class);
//                intent.putExtra("detail",list.get(holder.getAdapterPosition()).getType());
