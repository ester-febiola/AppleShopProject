...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyCartAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.name.setText(cartModelList.get(position).getProductPrice());
        holder.price.setText(cartModelList.get(position).getProductName());
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    ...
                                    Toast.makeText(context, "data success deleted", Toast.LENGTH_SHORT).show();
                                }else{
        ...
        // pass total priece amount to my cart fragment
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            quantity = itemView.findViewById(R.id.total_quanity);
